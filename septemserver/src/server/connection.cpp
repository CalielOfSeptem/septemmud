    ...
    : public std::enable_shared_from_this<impl>
{
    ...
    // CONSTRUCTOR
    // ======================================================================
    impl(std::shared_ptr<net::socket> const &socket)
      : socket_(socket),
        telnet_session_(
    ...
    // ON_DATA
    // ======================================================================
    void on_data(std::vector<boost::uint8_t> const &data)
    {
    ...
    std::vector<boost::uint8_t>                                unparsed_bytes_;
    ...
    std::function<void (boost::uint16_t, boost::uint16_t)>           on_window_size_changed_;
...
// CONSTRUCTOR
// ==========================================================================
connection::connection(std::shared_ptr<net::socket> const &socket)
